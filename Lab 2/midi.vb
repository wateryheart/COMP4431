...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tbSpeed.Size = New System.Drawing.Size(168, 45)
        ...
        Me.tbBankMSB.Size = New System.Drawing.Size(264, 45)
        ...
        Me.tbInstrument.Size = New System.Drawing.Size(264, 45)
...
#End Region
    ...
    Private Sub tmrSequencer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrSequencer.Tick
        ...
        Dim currentDataTime As Integer
        currentDataTime = CInt(midiSequence.data(currentIndex).time.TotalMilliseconds) + 1
        ...
        If (currentIndex < midiSequence.data.Length) Then
            Debug.Print("time" + tmrSequencer.Interval.ToString)
            tmrSequencer.Interval = CInt((midiSequence.data(currentIndex).time.Subtract(midiSequence.data(currentIndex - 1).time).TotalMilliseconds) * speed) + 1
            tmrSequencer.Enabled = True
        Else
    ...
    Private Sub btnRemoveSilence_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSilence.Click
        ...
        For i = 0 To midiSequence.dataLength - 1
            If ((midiSequence.data(i).midiMsg And &HF0) = &H80) And (offset = Nothing) Then
                offset = midiSequence.data(i).time
            ElseIf offset = Nothing Then
                midiSequence.data(i).time -= midiSequence.data(i).time
            End If
            midiSequence.data(i).time = midiSequence.data(i).time.Subtract(offset)
        Next
    End Sub
